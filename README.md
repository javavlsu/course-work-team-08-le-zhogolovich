...
| :--------- | :------------------------------- | :-------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------- |
| **GET**    | `/movies`                        | Список фильмов                          | **Query**: `query` (название), `genreId`, `tagId`, `countryId`, `year`, `sortBy` (def: name), `sortOrder` (def: desc), `page` (def: 0), `size` (def: 20) | Все входные параметры являются необязательными. Значения для sortBy и sortOrder — name/popularity/year и desc/asc соответственно |
...
| Метод      | Путь                                            | Описание                            | Параметры                                                                                                        | Body / Примечания                                                                                                            |
| :--------- | :---------------------------------------------- | :---------------------------------- | :--------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------- |
| **GET**    | `/compilations`                                 | Публичные подборки                  | **Query**: `query` (название), `sortBy` (def: title), `sortOrder` (def: desc), `page` (def: 0), `size` (def: 20) | Все входные параметры являются необязательными. Значения для sortBy и sortOrder — title/popularity и desc/asc соответственно |
...
| Метод      | Путь                           | Описание                                   | Параметры                                                                                                        | Body / Примечания                                                                                                            |
| :--------- | :----------------------------- | :----------------------------------------- | :--------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------- |
| **GET**    | `/reviews`                     | Список всех рецензий                       | **Query**: `query` (название), `sortBy` (def: title), `sortOrder` (def: desc), `page` (def: 0), `size` (def: 20) | Все входные параметры являются необязательными. Значения для sortBy и sortOrder — title/popularity и desc/asc соответственно |
...
| Метод      | Путь                            | Описание                                | Входные данные                                                                       | Примечания                                                                        |
| :--------- | :------------------------------ | :-------------------------------------- | :----------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| **GET**    | `/users`                        | Список всех юзеров                      | **Query**: `query` (имя), `sortOrder` (def: desc), `page` (def: 0), `size` (def: 20) | Все входные параметры являются необязательными. Значения для sortOrder — desc/asc |
| **GET**    | `/users/me`                     | Мой профиль                             | —                                                                                    | —                                                                                 |
| **PATCH**  | `/users/me`                     | Редактировать профиль                   | **Body**: `username`, `email`, `aboutMe`                                             | —                                                                                 |
| **PATCH**  | `/users/id/{id}`                | Редактировать профиль (для админа)      | **Body**: `username`, `email`, `aboutMe`                                             | —                                                                                 |
| **PATCH**  | `/users/me/avatar`              | Сменить аватар                          | **Multipart**: `file` (binary)                                                       | —                                                                                 |
| **PATCH**  | `/users/id/{id}/avatar`         | Сменить аватар (для админа)             | **Multipart**: `file` (binary)                                                       | —                                                                                 |
| **PATCH**  | `/users/{id}/role`              | Изменить роль пользователя (для админа) | **Body**: `role`                                                                     | Доступные роли: "USER", "REVIEWER"                                                |
| **DELETE** | `/users/me/delete-profile`      | Удалить свой профиль                    | —                                                                                    | —                                                                                 |
| **DELETE** | `/users/id/{id}/delete-profile` | Удалить профиль (по Id, для админа)     | **Path**: `id`                                                                       | —                                                                                 |
| **GET**    | `/users/id/{id}`                | Профиль по id                           | **Path**: `id`                                                                       | —                                                                                 |
| **GET**    | `/users/{username}`             | Профиль по username                     | **Path**: `username`                                                                 | —                                                                                 |
| **GET**    | `/users/me/followers`           | Список своих подписчиков                | —                                                                                    | —                                                                                 |
| **GET**    | `/users/me/followings`          | Список своих подписок на пользователей  | —                                                                                    | —                                                                                 |
| **GET**    | `/users/{username}/followers`   | Список чужих подписчиков                | —                                                                                    | —                                                                                 |
| **GET**    | `/users/{username}/followings`  | Список чужих подписок на пользователей  | —                                                                                    | —                                                                                 |
| **POST**   | `/users/follow/{id}`            | Подписаться на пользователя             | **Path**: `id`                                                                       | —                                                                                 |
| **DELETE** | `/users/follow/{id}`            | Отписаться от пользователя              | **Path**: `id`                                                                       | —                                                                                 |
...
## 7. Страны (country-controller)

Страны, в которых были сняты фильмы.
