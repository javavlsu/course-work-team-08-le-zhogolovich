          ...
          <form onSubmit={handleSubmit}>
            <div className="row align-items-start g-0">
              <div className="col-auto d-flex flex-column align-items-center">
                ...
                >
                  <div
                    className="rounded-circle overflow-hidden mb-4 shadow avatar-container"
                    style={{
                      width: "220px",
                      height: "220px",
                  ...
                  >
                    ...
                    <div
                      className="avatar-overlay d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100"
                      style={{
                  ...
                  <div
                    className="custom-btn user-pill py-3 px-5 text-center"
                    style={{
                      fontSize: "1.1rem",
                      width: "fit-content",
                      minWidth: "180px",
              ...
              <div className="col ps-md-5 pt-1">
                <div className="mb-4">
                  <label
                    className="text-white-50 mb-2 d-block"
